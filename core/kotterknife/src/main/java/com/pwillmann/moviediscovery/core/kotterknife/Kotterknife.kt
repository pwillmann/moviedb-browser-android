package com.pwillmann.moviediscovery.core.kotterknife
...
public fun <V : View> RecyclerView.ViewHolder.bindViews(vararg ids: Int): ReadOnlyProperty<RecyclerView.ViewHolder, List<V>> = required(ids, viewFinder)
...
public fun <V : View> RecyclerView.ViewHolder.bindOptionalViews(vararg ids: Int): ReadOnlyProperty<RecyclerView.ViewHolder, List<V>> = optional(ids, viewFinder)
...
object KotterKnife {
    /**
     * This must be used in fragments because the fragment might be re-used with a new view.
     */
    fun reset(target: Any) {
